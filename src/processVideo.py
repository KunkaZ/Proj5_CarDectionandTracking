...
# Function for using previous multiple frames to generate heat map
def MultiFrameDetection(captured, carlist):
...
def process_image(image):
	...
	heatmap = MultiFrameHeatMap(image,5)
	...
	# Combine old captures with new captures
	carslist = MultiFrameDetection(captured,carslist)
...
def MultiFrameHeatMap(refimg,nframe):
...
Input_video = '../Proj5_CarDectionandTracking/project_video.mp4'
video_output = '../Vehicle_Detections-master/project_video_output.mp4'
